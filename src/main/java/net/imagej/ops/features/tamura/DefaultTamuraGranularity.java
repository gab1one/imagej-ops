...
/**
 * Calculates the {@link TamuraGranularity} of a {@link Iterable}
 * Created by gabriel on 20/11/14.
 * TODO find out what
 */
@Plugin(type = Op.class, label = TamuraGranularity.LABEL, name = TamuraOps.TamuraGranularity.NAME, priority = Priority.VERY_HIGH_PRIORITY)
public class DefaultTamuraGranularity
