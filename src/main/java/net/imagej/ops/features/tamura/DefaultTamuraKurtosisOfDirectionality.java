...
public class DefaultTamuraKurtosisOfDirectionality
        implements TamuraFeatures.TamuraGranularityFeature {

    @Parameter
    private DefaultTamuraKurtosisOfDirectionalityHelper directionality;

    @Parameter(type = ItemIO.OUTPUT)
    private double out;

    @Override public void run() {
        out = directionality.getFeatureValue();
        }
